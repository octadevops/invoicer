...
import { handleSubmit } from "../services/invoiceServices";
...
export default function InvoiceForm() {
  ...
  const handleImageChange = (e) => {
    ...
    reader.onload = () => {
      ...
      setImageBinary(binaryStr); // Set the binary data for the image
    };
  ...
  const onFormSubmit = async (e) => {
    ...
    // Call the handleSubmit function from the invoiceService
    ...
    if (result) {
      ...
      setIsComplete(false);
      setImage(null);
      setImageBinary(null); // Clear the image binary data
      setInvoiceNo(generateInvoiceNumber());
    }
  };
